...
export const FIELD_DEFS: readonly FieldDef[] = [
  ...
  { key: "seamJoinText", type: "text", label: "On-the-line join text", value: " + ", group: "Spin Behavior", hint: "Placed between the two options when the wheel lands on the line, e.g. \"A\" + \"B\"." },
