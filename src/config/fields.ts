...
export const FIELD_DEFS: readonly FieldDef[] = [
  ...
  { key: "titleFontSize", type: "slider", label: "Title text size", value: 15, min: 8, max: 40, step: 1, group: "Wheel Settings", hint: "Size of the title text; the pill grows to match." },
  { key: "titleGap", type: "slider", label: "Title spacing", value: 52, min: 0, max: 60, step: 2, group: "Wheel Settings", hint: "Gap between the title pill and the top of the wheel." },
  ...
  { key: "seamSnap", type: "checkbox", label: "Snap onto the line", value: false, group: "Spin Behavior", hint: "On an on-the-line landing: off (default) leaves the wheel where it naturally stopped and just counts it as on the line; on glides the pointer onto the exact divider." },
  ...
  { key: "hubImage", type: "text", label: "Hub image URL", value: "", group: "Center Hub", accept: "image/*", hint: "Pick a file to embed it, or paste an image URL or a base64 data URL. Transparent margins are trimmed automatically. Shown when Hub content = Image." },
