...
export const FIELD_DEFS: readonly FieldDef[] = [
  ...
  { key: "seamResult", type: "dropdown", label: "On-the-line result", value: "respin", options: { respin: "Spin again", both: "Both options win" }, group: "Spin Behavior", hint: "Magnetism off only: when the wheel stops on the line between two slices, either re-spin or count both as winners." },
  ...
  { key: "soundWin", type: "sound-input", label: "Win sound", value: "", group: "Sounds", hint: "Overrides the built-in synthesized win sound. Leave blank to use it." },
  { key: "soundTick", type: "sound-input", label: "Tick sound", value: "", group: "Sounds", hint: "Overrides the built-in synthesized tick. Leave blank to use it." },
  { key: "soundSeam", type: "sound-input", label: "On-the-line sound", value: "", group: "Sounds", hint: "Plays when the wheel lands on a seam (magnetism off). Overrides the built-in synth." },
  ...
  { key: "commandPermission", type: "dropdown", label: "Command permission", value: "broadcaster", options: { broadcaster: "Broadcaster only", mods: "Broadcaster + Mods" }, group: "Commands" },
