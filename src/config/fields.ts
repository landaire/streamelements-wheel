...
export const FIELD_DEFS: readonly FieldDef[] = [
  ...
  { key: "colorScheme", type: "dropdown", label: "Color scheme", value: "grape", options: { grape: "Grape", fuchsia: "Fuchsia", "sweetheart-original": "Sweetheart", custom: "Custom" }, group: "Colors", hint: "Pick Custom to use the color pickers below." },
