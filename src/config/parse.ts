...
export interface WheelConfig {
  ...
  magnetism: boolean;
  seamBandDeg: Degrees;
  seamSnap: boolean; // on a seam landing, glide onto the exact divider vs rest where it landed
...
export function parseConfig(fieldData: FieldData): Parsed<WheelConfig> {
  ...
  return {
    ...
    value: {
      ...
      seamSnap: bool(fieldData.seamSnap, FIELD_DEFAULTS.seamSnap as boolean),
