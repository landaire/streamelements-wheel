...
describe("fields schema", () => {
  ...
  it("covers every key parseConfig reads", () => {
    const required = ["sliceEntries", "wheelStyle", "wheelTitle", "spinDuration", "countdownTime", "countdownText", "spinningText", "magnetism", "seamBand", "respinText", "spinCommand", "colorScheme", "centerIcon", "scaleWidget", "soundWin", "soundTick", "disableConfetti"];
